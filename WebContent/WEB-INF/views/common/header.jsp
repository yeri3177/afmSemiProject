...
.headerDropDownMenu {display: none;position: fixed;background-color: #f1f1f1;min-width: 160px;box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2);z-index: 99999;}
...
.headerDropDown:hover .headerDropDownBtn {background-color: #3e8e41;}
</style>
</head>
<body>
    <!-- Header -->
