	...
	<form name="userUpdateFrm" action="<%=request.getContextPath()%>/user/userUpdate" method="POST">
		<table>
			...
			<tr>
				<th>주소<sup>*</sup></th>
				<td>	
					 <input type="text" placeholder="우편번호" name="address" id="address"><br> 
					 <input type="text" placeholder="" name="address" id="address" value="<%= loginUser.getAddress() != null ? loginUser.getAddress().getAdrRoad() : "" %>"><br> 
					 <input type="text" placeholder="" name="address" id="address" value="<%= loginUser.getAddress() != null ? loginUser.getAddress().getAdrDetail() : "" %>"><br> 
				</td>
			</tr>
...
%>
			<tr>
				<th>계좌<sup>*</sup></th>
				<td>
					<input type="text" placeholder="계좌은행" name="banknum" id="banknum" maxlength="11" value="<%= loginUser.getAccount().getBankName() %>" required><br>
					<input type="text" placeholder="계좌번호" name="banknum" id="banknum" maxlength="11" value="<%= loginUser.getAccount().getAccountNumber() %>" required><br>
				</td>
			</tr>
<%
	}
